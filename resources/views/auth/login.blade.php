                    ...
                    <div class="card-body p-5">
                        <form id="loginForm">
                            ...
                            <div class="form-group row mb-3">
                                <label for="cellphone"
                                    class="col-md-4 col-form-label text-md-right">شماره تلفن همراه</label>

                                <div class="col-md-6">
                                    <input id="cellphone" type="text"  dir="ltr" class="form-control" required autocomplete="cellphone" autofocus>
                        ...
                        <form id="checkOTPForm">
                            ...
                            <div class="form-group row mb-3">
                                <label for="checkOTPInput"
                                    class="col-md-4 col-form-label text-md-right"> رمز یکبار مصرف  </label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-12 d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <button id="resendOTPButton" class="btn btn-sm btn-info" type="button">ارسال مجدد</button>
