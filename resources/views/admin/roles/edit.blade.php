                ...
                <div class="col-12">
                    <div class="row pt-md-5 mt-md-3 mb-5">
                        ...
                        <div class="col-xl-12 col-sm-12 mb-4 p-3 bg-white">
                            <h5 class="font-weight-bolder">ویرایش نقش {{ $role->name }}</h5>
                            <hr>
                            ...
                            <form action="{{ route('admin.roles.update' , ['role' => $role->id]) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('display_name') is-invalid @enderror" id="display_name" name="display_name" value="{{ $role->display_name }}">
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
