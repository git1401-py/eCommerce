                                ...
                                <div class="form-row d-flex align-items-center">
                                    ...
                                    <div class="form-group col-md-3 small text-muted">
                                        ...
                                        <div style="font-size:10px;">
                                            ...
                                            dir="rtl" language="fa" name="attribute_ids[]" multiple="multiple">
                                    ...
                                    <div class="form-group col-md-3 small text-muted">
                                        ...
                                        <div style="font-size:10px;">
                                            ...
                                            dir="rtl" language="fa" id="attributeIsFilterSelect" name="attribute_is_filter_ids[]" multiple="multiple">
                                    ...
                                    <div class="form-group col-md-3 small text-muted">
                                        ...
                                        <div style="font-size:10px;">
                                            ...
                                            dir="rtl" language="fa" id="variationSelect" name="variation_id">
